---
title: "Estructura del Proyecto: archivos, directorios y HTML"
sidebarTitle: "Estructura"
description: "Explora la organización de archivos de Licorería Santo Pecado: index.html, styles.css, assets de imagen y las secciones estructurales del HTML."
---
...
<AccordionGroup>
  ...
  <Accordion title="<footer> — Pie de página con redes sociales">
    Muestra el aviso de copyright *© 2025 Licorería Santo Pecado* y dos enlaces de texto plano (sin URL definitiva) a **Facebook** e **Instagram**, separados por un carácter `|`. Aplica las clases `text-center bg-light text-dark p-3 mt-5`, lo que le da fondo claro y texto oscuro, diferenciándolo del resto del sitio. Los enlaces están estilizados en rojo (`color: #ff0000`) y muestran subrayado al pasar el cursor, definido en la regla `footer a:hover` de `styles.css`.
  </Accordion>
</AccordionGroup>
