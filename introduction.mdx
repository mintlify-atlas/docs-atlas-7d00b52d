...
<CardGroup cols={3}>
  <Card title="HTML5" icon="html5" href="https://developer.mozilla.org/es/docs/Web/HTML">
  ...
  <Card title="CSS3 Avanzado" icon="css3" href="https://developer.mozilla.org/es/docs/Web/CSS">
  ...
  <Card title="Bootstrap 5" icon="bootstrap" href="https://getbootstrap.com/docs/5.3/">
